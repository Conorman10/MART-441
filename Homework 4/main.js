...
function restartStory() {
    ...
    document.getElementById("question").innerHTML = "You are asked an important question: What do you prefer? Waffles or Ice Cream?";
...
function getChoice1() {
    var myChoice = document.getElementById("choice").value.toLowerCase().trim();
    ...
    if (myChoice === "waffles") {
        ...
        myQuestion.innerHTML = "Hmmm, ice cream is pretty alright I guess... perhaps you are a human after all. But, if you don't mind me asking, what is your favorite movie?";
    } else {
        myQuestion.innerHTML = "Invalid answer. Please enter 'waffles' or 'ice cream'.";
    }
}
...
function getChoice2() {
    ...
    if (answer === "morbius") {
        ...
        myQuestion.innerHTML = "Wow, you are pitiful and disgusting! How dare you even try to call yourself a human?! I'm getting away from you!!";
        ...
        myQuestion.innerHTML = "Invalid answer. Please enter 'Morbius' or 'Madame Web'.";
    }
}
