function storyFunction(choice) {
    ...
    if (choice == 1 && answer1 == "Yes") {
        document.getElementById("story").innerHTML = "Pingus walks alone in the terrifying emptiness of the arctic. Ahead, he sees a shadowy figure";
        document.getElementById("choice1").innerHTML = "Walk towards it";
